...
他社の事情を知らないのですが、あまりない取り組みなんじゃないかと思っています。
参考になれば幸いです。
...
なるべく社内の部署毎にニーズを満たせるようにグループを分けていますが、結局参加してくれている人はほぼ全部に入ってくれています。
...
学生時代に Slack を使って仲間内で同じことをやっていたので、上記の解決手段として RSS グループを思いついたわけです。
