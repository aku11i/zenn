...
CSS や UI/UX・CG など、デザイナーに有益なサイトを登録しています。

### IT 知識

スマホ・PC・OS などの新着情報を集めています。
スマホゲーの開発もしているので、変態スマホとかにはアンテナを張っておかないといけないです。

### 業界情報

業界ニュースや取引先・競合他社のプレスリリースなどを集めています。
自社の広報ブログとかも入れてます。
...
学生時代に Slack を使って仲間内で同じことをやっていたので、上記の解決手段として RSS チャンネルを思いつきました。
...
四六時中投稿されていては社員の集中力を妨げる可能性があるため、上司と相談して日中の毎時 20 分と 50 分に投稿するようにしています。
...
実はこの度退職することとなったのですが、RSS チャンネルに関しては上司から運用を継続したい要望があり、運用方法など資料に残しました。
...
既にあるか分かりませんが、パッケージ化して効果測定なども行えるようにすれば法人向けにウケそうじゃないでしょうか？
